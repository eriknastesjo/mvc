 ...
 */
final class Version20220524112933 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD COLUMN first_name VARCHAR(15) NOT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN last_name VARCHAR(15) NOT NULL');
        $this->addSql('ALTER TABLE user ADD COLUMN img_url VARCHAR(30) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('INSERT INTO garden_sales (id, plant, price, date, time) SELECT id, plant, price, date, time FROM __temp__garden_sales');
        $this->addSql('DROP TABLE __temp__garden_sales');
        $this->addSql('CREATE TEMPORARY TABLE __temp__user AS SELECT id, acronym, password, status FROM user');
        ...
        $this->addSql('INSERT INTO user (id, acronym, password, status) SELECT id, acronym, password, status FROM __temp__user');
